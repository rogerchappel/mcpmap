...
Replace this section with the supported versions for `mcpmap`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `mcpmap` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in mcpmap.
